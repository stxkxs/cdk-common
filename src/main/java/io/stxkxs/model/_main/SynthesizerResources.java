...
public record SynthesizerResources(Kms kms, S3Bucket assets, EcrRepository ecr, IamRole cdkExec, IamRole cdkDeploy, IamRole cdkLookup,
  IamRole cdkAssets, IamRole cdkImages) {}
