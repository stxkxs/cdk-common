...
public record Rule(String name, boolean enabled, boolean scanEnabled, List<String> recipients, List<S3ActionConf> s3Actions,
  List<SnsActionConf> snsActions, List<LambdaActionConf> lambdaActions) {}
