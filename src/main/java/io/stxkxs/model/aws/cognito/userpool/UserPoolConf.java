...
/**
 * Comprehensive AWS Cognito User Pool configuration record that defines complete user 
 * authentication, authorization, and management settings for identity and access management.
 * 
 * <p>This configuration record orchestrates all aspects of Cognito User Pool setup including
 * user registration, authentication flows, multi-factor authentication, custom attributes,
 * external service integrations, and advanced security features.
 * 
 * <p><b>Core Authentication Features:</b>
 * <ul>
 ...
 * </ul>
 * 
 * <p><b>User Management Capabilities:</b>
 * <ul>
 ...
 * </ul>
 * 
 * <p><b>External Service Integration:</b>
 * <ul>
 ...
 * </ul>
 * 
 * <p><b>Configuration Complexity:</b>
 * This record represents one of the most complex authentication configurations in AWS,
 * involving multiple interrelated settings that affect user experience, security posture,
 * and integration patterns across web and mobile applications.
 * 
 * <p><b>Template Integration:</b>
 * Most fields support template-based configuration allowing dynamic injection of
 * environment-specific values, ARNs, and computed configuration parameters at
 * deployment time through the CDK framework's template processing engine.
 * 
 * <p><b>Usage Example:</b>
 * <pre>{@code
 * UserPoolConf config = new UserPoolConf(
 *     "my-app-users",                    // name
 ...
 * }</pre>
 * 
 * @param name Unique name identifier for the Cognito User Pool
 * @param triggers JSON configuration for Lambda trigger integrations
 * @param accountRecovery Account recovery method configuration
 * @param standardThreatProtectionMode AWS advanced threat protection settings
 * @param sns JSON configuration for SNS integration and SMS delivery
 * @param ses JSON configuration for SES integration and email delivery  
 * @param groups List of user groups with roles and permissions
 * @param autoVerify Automatic verification settings for email and phone
 * @param mfa Multi-factor authentication configuration and requirements
 * @param passwordPolicy Password complexity and security requirements
 * @param verification User verification method configuration
 * @param deviceTracking Device memory and tracking settings
 * @param aliases Allowed sign-in aliases (username, email, phone)
 * @param standardAttributes Configuration for AWS standard user attributes
 * @param customAttributes List of application-specific custom user attributes
 * @param keepOriginalAttributes Which attributes to preserve during user updates
 * @param signInCaseSensitive Whether usernames are case sensitive
 * @param deletionProtection Protect user pool from accidental deletion
 * @param selfSignup Allow users to register themselves
 * @param removalPolicy CDK removal policy for user pool deletion
 * @param tags Resource tags for billing, management, and organization
 * 
