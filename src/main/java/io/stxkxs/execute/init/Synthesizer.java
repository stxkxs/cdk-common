...
@Slf4j
@Getter
public class Synthesizer extends NestedStack {
  private final KmsConstruct key;
  private final StringParameter version;
  private final SystemRoles roles;
  private final SystemStorage storage;

  public Synthesizer(Construct scope, Common common, SynthesizerResources root, NestedStackProps props) {
