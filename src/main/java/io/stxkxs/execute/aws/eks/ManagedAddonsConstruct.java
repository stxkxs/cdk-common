...
/**
 * AWS EKS Managed Add-ons orchestration construct that provisions and configures
 * essential Kubernetes cluster components with AWS-managed lifecycle and updates.
 * 
 * <p>This construct manages the complete suite of AWS-provided EKS add-ons, featuring
 * nested inner classes for specialized add-on handling and complex OIDC integration:
 * 
 * <p><b>Managed Add-on Components:</b>
 * <ul>
 ...
 * </ul>
 * 
 * <p><b>EBS CSI Specialization:</b>
 * The {@code AwsEbsCsiConstruct} inner class provides enhanced functionality:
 * <ul>
 ...
 * </ul>
 * 
 * <p><b>Service Account Role Binding:</b>
 * Each add-on that requires AWS permissions automatically receives:
 * <ul>
 ...
 * <p><b>Usage Example:</b>
 * <pre>{@code
 * ManagedAddonsConstruct addons = new ManagedAddonsConstruct(
 *     this, common, kubernetesConfig, cluster);
 *     
