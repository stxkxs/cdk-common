...
/**
 * Comprehensive Amazon RDS Aurora PostgreSQL cluster construct that provides enterprise-grade
 * relational database infrastructure with advanced features including read replicas, backup management,
 * performance insights, and secure credential management.
 * 
 * <p>This construct orchestrates the creation of production-ready Aurora PostgreSQL clusters with
 * sophisticated configuration options, security features, and operational capabilities required
 * for high-availability database deployments.
 * 
 * <p><b>Core Database Features:</b>
 * <ul>
 ...
 * </ul>
 * 
 * <p><b>High Availability Architecture:</b>
 * <ul>
 ...
 * </ul>
 * 
 * <p><b>Performance and Monitoring:</b>
 * <ul>
 ...
 * </ul>
 * 
 * <p><b>Serverless v2 Integration:</b>
 * The construct supports Aurora Serverless v2 for cost optimization:
 * <ul>
 ...
 * <p><b>Usage Example:</b>
 * <pre>{@code
 * RdsConstruct database = new RdsConstruct(
 *     this, 
 *     common, 
 *     rdsConfig, 
 *     vpc, 
